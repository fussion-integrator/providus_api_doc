...
<div class="method get">GET</div> `/api/v1/payment/nip/account`
...
```curl
curl -X GET "https://api.providusbank.com/api/v1/payment/nip/account" \
...
var response = await client.GetAsync("https://api.providusbank.com/api/v1/payment/nip/account");
